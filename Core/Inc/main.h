...
#define S1_SHLD_BUTTON_Pin GPIO_PIN_1
#define S1_SHLD_BUTTON_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define S2_SHLD_BUTTON_Pin GPIO_PIN_4
#define S2_SHLD_BUTTON_GPIO_Port GPIOA
#define LD2_Pin GPIO_PIN_5
#define LD2_GPIO_Port GPIOA
#define S3_SHLD_BUTTON_Pin GPIO_PIN_0
#define S3_SHLD_BUTTON_GPIO_Port GPIOB
